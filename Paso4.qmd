...
```{r,corregir-fig-ajuste-1, fig.cap= "Índices de ajuste, modelo sin covariable", echo=FALSE}
rm(list = ls());gc()
...
```{r,corregir-fig-ajuste-2, fig.cap= "Índices de ajuste, modelo variable distal", echo=FALSE}
...
::: controlly
```{r,corregir-tabla-descriptiva, echo=FALSE}
...
```{r, clasificaciones-no-ajustado, fig.cap= "Distribución de categorías del modelo", echo=FALSE}
...
```{r, clasificaciones-res-distal,  fig.cap= "Distribución de categorías del modelo ajustado", echo=FALSE}
...
::: controlly
```{r,corregir-fig-ajuste-3, echo=FALSE}
#rm(list = ls());gc()
...
tab_ppio %>%#
  ...
  # convert character columns to numeric
    knitr::kable(format="markdown", caption="Medidas de ajuste")#%>%    rio::export("table_fit.xlsx")
```
:::

::: controlly
```{r,corregir-fig-ajuste-4, echo=FALSE}
tab_ppio2 %>%#
  dplyr::select(ModelIndex, everything()) %>% 
    dplyr::mutate_if(is.character, as.numeric) %>% 
...
```{r, clasificaciones-no-ajustado-alt, fig.cap= "Distribución de categorías del modelo (alternativo)", echo=FALSE}
...
```{r, clasificaciones-res-distal-alt,  fig.cap= "Distribución de categorías del modelo ajustado (alternativo)", echo=FALSE}
