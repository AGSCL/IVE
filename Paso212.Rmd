...
```{r, echo=FALSE}
rm(list = ls());gc()
load("data2_lca211_sin_po_alt_2023_05_12.RData")
```
...
f_adj<- item(AÑO, CAUSAL, EDAD_MUJER_REC, PAIS_ORIGEN_REC, HITO1_EDAD_GEST_SEM_REC, MACROZONA, PREV_TRAMO_REC) ~ outcome
