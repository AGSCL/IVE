...
preds <- c("CAUSAL","EDAD_MUJER_REC", "PUEBLO_ORIGINARIO_REC","PAIS_ORIGEN_REC", "HITO1_EDAD_GEST_SEM_REC", "MACROZONA", "AÑO", "PREV_TRAMO_REC")
...
f_preds<-cbind(CAUSAL, EDAD_MUJER_REC, PUEBLO_ORIGINARIO_REC, PAIS_ORIGEN_REC, HITO1_EDAD_GEST_SEM_REC, MACROZONA, AÑO, PREV_TRAMO_REC)~ 1
f_adj <- cbind(CAUSAL, EDAD_MUJER_REC, PUEBLO_ORIGINARIO_REC, PAIS_ORIGEN_REC, HITO1_EDAD_GEST_SEM_REC, MACROZONA, AÑO, PREV_TRAMO_REC)~ HITO2_DECISION_MUJER_IVE
...
Corrimos una versión paralelizada de `poLCA`.
...
labels <- c('Log-Verosimilitud', 'Chi2', 'valor p Chi2', 'Grados de libertad', 
            'Criterio de Información\nde Akaike(AIC)', 'Criterio de Información\nBayesiano (BIC)', 'BIC Ajustado (SABIC)', "AIC Corregido",'G-squared/Deviance', 'Valor p G-squared', 'Entropía Relativa', 'Entropía R2', 'Cambio en Deviance\n(con modelo previo)', 'Grados de libertad del cambio', 'valor p cambio deviance', 'BLRT', 'valor p BLRT')
