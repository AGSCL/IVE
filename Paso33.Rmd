...
rio::export(subset(mydata_preds3, nrow==1), "base_entrenamiento_sin_po.dta")
```
...
lcmodel %>% rio::export("variables_probabilities_in_category_sin_po.xlsx")
```
...
tidy(LCA_best_model_mod) %>% rio::export("variables_class_estimate_sin_po.xlsx")
```
...
lcmodel_adj %>% rio::export("variables_probabilities_in_category_adj_sin_po.xlsx")
```
...
tidy(LCA_best_model_adj_mod) %>% rio::export("variables_class_estimate_adj_sin_po.xlsx")
```
