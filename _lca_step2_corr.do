...
~~~~
<<dd_do>>
log using "[DIRECTORIO CARPETA]_lca\registry_lca2.smcl", replace
...
The file is located and named as: <<dd_display: "`c(pwd)'/_lca/lca_step1.dta" >>

<<dd_do:quietly>>
*a) open 
	use "./_lca/lca_step1.dta"

<</dd_do>>

According to the data, the model with four latent classes was the model that had best fit to the data.

~~~~
<<dd_do>>
*cap noi estread "./_lca/analisis_lcas_tests_prueba.sters"
cap noi estread "./_lca/analisis_lcas_tests_real.sters"
...
*cap noi estwrite _all using "./_lca/analisis_lcas_tests_definitivo_prueba.sters", replace
cap noi estwrite _all using "./_lca/analisis_lcas_tests_definitivo.sters", replace
...
*cap noi estread "./_lca/analisis_lcas_tests_definitivo_prueba.sters"
cap noi estread "./_lca/analisis_lcas_tests_definitivo.sters"
...
marginsplot, xtitle("") ytitle("") ///
	...
	cap noi graph save "./_lca/plot_predict_probs.gph"
	
<</dd_do>>
~~~~

<<dd_graph: saving("./_lca/lca.svg") width(800) replace>>
...
cap noi estwrite _all using "./_lca/analisis_lcas_tests_definitivo2.sters", replace
...
cap qui save "./_lca/lca_step2.dta", all replace emptyok
...
cap rm "[DIRECTORIO CARPETA]_lca/_lca_step2_corr.html"
dyndoc "[DIRECTORIO CARPETA]_lca\_lca_step2_corr.do", saving("[DIRECTORIO CARPETA]_lca\_lca_step2_corr.html") replace nostop 
copy "[DIRECTORIO CARPETA]_lca\_lca_step2_corr.html" "[DIRECTORIO CARPETA]_lca_step2_corr.html", replace
