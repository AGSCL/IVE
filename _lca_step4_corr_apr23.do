...
<<dd_include: "G:/Mi unidad/Angelica/secreto/IVE/header.txt" >>

# Análisis de clases latentes (paso 4, con resultado distal)
...
<<dd_do>>
clear all
log using "H:\Mi unidad\Angelica\secreto\IVE\registry_lca4_apr23.smcl", replace
log using "G:\Mi unidad\Angelica\secreto\IVE\registry_lca4_apr23.smcl", replace
...
El archivo se encuentra en: <<dd_display: "`c(pwd)'/_lca/lca_step3_covs_apr23.dta" >>

<<dd_do:quietly>>
*a) open 
	use "./lca_step3_covs_apr23.dta"
...
qui noi gsem(CAUSAL ///
	...
	MACROZONA  ///		// ANIO ///
	PREV_TRAMO_REC <- outcome, mlogit), lclass(C 6) nocapslatent nonrtolerance from(b6_start, skip) ///
...
cap noi estwrite _all using "./analisis_lcas_tests_definitivo_covs_apr23.sters", replace
...
cap noi estread "analisis_lcas_tests_definitivo_covs_apr23.sters"
...
marginsplot, xtitle("") ytitle("") ///
	...
	cap noi graph save "plot_predict_probs_covs_apr23.gph"
...
cap noi estwrite _all using "./analisis_lcas_tests_definitivo2_covs_apr23.sters", replace
...
~~~~
<<dd_do>>
cap qui save "./lca_step4_covs_apr23.dta", all replace emptyok
...
cap rm "H:/Mi unidad/Angelica/secreto/IVE/lca_step4_corr_apr23.html"
dyndoc "H:\Mi unidad\Angelica\secreto\IVE\_lca_step4_corr_apr23.do", saving("H:\Mi unidad\Angelica\secreto\IVE\lca_step4_corr_apr23.html") replace nostop 
copy "H:\Mi unidad\Angelica\secreto\IVE\lca_step4_apr23_corr_apr23.html" "H:\Mi unidad\Angelica\secreto\IVE\lca_step4_corr_apr23_back.html", replace

cap rm "G:/Mi unidad/Angelica/secreto/IVE/lca_step4_corr_apr23.html"
dyndoc "G:\Mi unidad\Angelica\secreto\IVE\_lca_step4_corr_apr23.do", saving("G:\Mi unidad\Angelica\secreto\IVE\lca_step4_corr_apr23.html") replace nostop 
copy "G:\Mi unidad\Angelica\secreto\IVE\lca_step4_corr_apr23.html" "G:\Mi unidad\Angelica\secreto\IVE\lca_step4_corr_apr23_back.html", replace
<</dd_do>>  
~~~~
