...
title: "Paso 2.10"
description: |
  Análisis de clases latentes exploratoria y comparativa con predictores, sin pueblo originario, pero con año y recategorización de edad mujer y semana gestacional hito 1
...
rm(list = ls());gc()
print(Sys.time())
load("data2_lca2_sin_po_2023_05_08.RData")
```

Cargamos los paquetes

```{r, echo=FALSE, results="hide", error=T}
...
gr_lca2 %>%
  export_svg %>% charToRaw %>% rsvg_pdf("_flowchart_lca_adj_sin_po.pdf")
...
htmlwidgets::saveWidget(gr_lca2, "_flowchart_lca_adj_sin_po.html")
webshot::webshot("_flowchart_lca_adj.html", "_flowchart_lca_adj_sin_po.png",vwidth = 1200, vheight = 900,
        zoom = 2)
```
...
#0h s
f_adj<-cbind(AÑO, CAUSAL, EDAD_MUJER_REC, PAIS_ORIGEN_REC, HITO1_EDAD_GEST_SEM_REC, MACROZONA, PREV_TRAMO_REC)~ outcome
...
fig_lca_fit2
ggsave("_fig2_comparison_adj_sin_po.png",fig_lca_fit2, dpi=600)
...
```{r, echo=FALSE}
print(Sys.time())
save.image("data2_lca2_adj_sin_po.RData")
```
