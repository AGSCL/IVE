...
```{r adj-fig4-regression, echo=T, fig.align='center', fig.pos='H', fig.cap= "Probabilidad predicha de presentar interrupción del embarazo por clase", message=FALSE, error=T, eval=T, fig.height=10}

plot(effects::allEffects(LCA_best_model_adj_mod))
```
